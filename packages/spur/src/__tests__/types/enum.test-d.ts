...
describe('oneOfSchema - basic types', () => {
  ...
  it('nullish string enum schema', () => {
    ...
    expectTypeOf<InferOutput<typeof _schema>>().toEqualTypeOf<'red' | 'green' | 'blue' | null | undefined>()
  })

  it('nullish number enum schema', () => {
    const _schema = oneOf([1, 2, 3] as const).nullish()
    expectTypeOf<InferOutput<typeof _schema>>().toEqualTypeOf<1 | 2 | 3 | null | undefined>()
  })
...
describe('oneOfSchema - with defaults', () => {
  ...
  it('enum with default then nullish', () => {
    ...
    expectTypeOf<InferOutput<typeof _schema>>().toEqualTypeOf<'x' | 'y' | null | undefined>()
  })
