...
describe('booleanSchema - basic types', () => {
  ...
  it('optional boolean schema', () => {
    ...
    expectTypeOf<ExtractOutputType<typeof _schema>>().toEqualTypeOf<boolean | undefined>()
  })
  ...
  it('nullish boolean schema', () => {
    ...
    expectTypeOf<ExtractOutputType<typeof _schema>>().toEqualTypeOf<boolean | null | undefined>()
  })
