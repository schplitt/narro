 ...
 */
export type ExtractSchemas<T extends BuildableSchema, TKey extends string, TValue> = T extends BuildableSchema<any, any, infer TCommonOptions> ? TCommonOptions extends { [K in TKey]: TValue } ? T : never : never

/**
 * Extracts the options from a schema
 */
export type ExtractOptions<T extends BuildableSchema> = T extends BuildableSchema<any, any, infer TCommonOptions> ? TCommonOptions : never

export type MakeOptional<TOptions extends CommonOptions> = SetCommonOption<TOptions, 'optionality', 'optional'>
export type ExtractOptionalSchema<T extends BuildableSchema> = ExtractSchemas<T, 'optionality', 'optional'>

export type MakeRequired<TOptions extends CommonOptions> = SetCommonOption<TOptions, 'optionality', 'required'>
export type ExtractRequiredSchema<T extends BuildableSchema> = ExtractSchemas<T, 'optionality', 'required'>

export type MakeNullable<TOptions extends CommonOptions> = SetCommonOption<TOptions, 'optionality', 'nullable'>
export type ExtractNullableSchema<T extends BuildableSchema> = ExtractSchemas<T, 'optionality', 'nullable'>

export type MakeNullish<TOptions extends CommonOptions> = SetCommonOption<TOptions, 'optionality', 'nullish'>
export type ExtractNullishSchema<T extends BuildableSchema> = ExtractSchemas<T, 'optionality', 'nullish'>

export type MakeDefaulted<TOptions extends CommonOptions> = SetCommonOption<TOptions, 'optionality', 'defaulted'>
export type ExtractDefaultedSchema<T extends BuildableSchema> = ExtractSchemas<T, 'optionality', 'defaulted'>

export type MakeUndefinable<TOptions extends CommonOptions> = SetCommonOption<TOptions, 'optionality', 'undefinable'>
export type ExtractUndefinableSchema<T extends BuildableSchema> = ExtractSchemas<T, 'optionality', 'undefinable'>
